...
export default class Spin {
    ...
    printResult() {
        ...
        {console.log(this.scene , "baseSpin")}
        if(autoSpin) {
            ...
            s1 = this.scene.data.parent.container;
            s2 = this.scene.data.parent.container2;
            s3 = this.scene.data.parent.container3;
            s4 = this.scene.data.parent.container4;
            s5 = this.scene.data.parent.container5;
        }
        //push symbols name
    ...
    getLineArray(lineArr) {
        ...
        for(let i = 0; i < lineArr.length; i++) {
            ...
            Options.lineArray.push(new Sprite(this.scene, Config.width / 2, 
                Config.height / 2.175, 'line', lineName));
        }
    }
