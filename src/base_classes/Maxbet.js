...
export default class Maxbet {
    ...
    addMaxbet() {
        this.maxBet = new Sprite(this.scene, Config.width - 577, Config.height - 68, 'bgButtons', 'btn-maxbet.png');
        this.maxBet.scale = 0.79
