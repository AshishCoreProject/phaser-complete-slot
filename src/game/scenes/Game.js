...
export  class Game extends Phaser.Scene {
    ...
    preload() {
        this.load.image("bg", "https://i.postimg.cc/135ZZWJL/bg.png");
        this.load.spritesheet('symbols', 'path/to/symbols.png', { frameWidth: 150, frameHeight: 150 });
    }
    ...
    create() {
        ...
        // const bg = new Sprite(this, 750 , 350 , 'background', 'bg.jpg');
        //container
        this.container = new Container(this, Config.width - 940, Config.height - 45);
        this.container2 = new Container(this, Config.width - 790, Config.height - 45);
        this.container3 = new Container(this, Config.width - 640, Config.height - 45);
        this.container4 = new Container(this, Config.width - 490, Config.height - 45);
        this.container5 = new Container(this, Config.width - 330, Config.height - 45);

        //add image machine
        // const machine = new Sprite(this, 750, 350, 'background', 'machine.png');
        // machine.setOrigin(0.5, 0.5); // Centers the texture within the sprite
    ...
    update(){
        if (moneyStore.isAddMoney) {
            console.log("isAddMoney is true, triggering money update!");
            moneyStore.isAddMoney = false; // Reset the flag after processing
            this.currMoney = localStorage.getItem('money') ? localStorage.getItem('money') :
            Options.money;
            this.currMoney = Number(this.currMoney);
            this.currMoney += moneyStore.money;
            console.log(this.currMoney, "current money");
            console.log(moneyStore, "moneyStore");
            this.txtMoney = this.add.text(Config.width - 1050, Config.height - 695, this.currMoney + '$', {
                fontSize : '30px',
                color : '#fff',
                fontFamily : 'PT Serif'
            });
            this.setTextX(this.currMoney);
          }
    }  
}